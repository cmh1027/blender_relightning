...
from math import *
pose = os.path.join(ROOT_DIR, "sparse", SCENE, f"transform_train.json")
...
HDR = "nerfactor"
RESULTS_PATH = os.path.join(ROOT_DIR, f"sparse/{SCENE}")
file = os.path.join(ROOT_DIR, PROBE, HDR, "city.hdr")
